...
echo "Go somewhere with external controller"
rosservice call /cf3/Commander_Node/goTo_srv "[0.5, 0.0, 0.5]" "3.0" "false"
sleep 3

echo "Switch to internal controller"
rosservice call /cf3/Commander_Node/ctrl_offboard_srv "offboard_active: false"

echo "Move with internal controller"
rosservice call /cf3/Commander_Node/goTo_srv "[0.0, 0.0, 0.5]" "3.0" "false"
sleep 3
